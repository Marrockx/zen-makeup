...
import tempfile
import time
from PIL import Image, ImageColor, ImageGrab
import csv
import os
...
while vid2.isOpened():
    ...
    try:
        ...
        if ret_val:
            ...
            feat_applied = apply_all_makeup(frame2, True, features, show_points)
        ...
        try:
            ...
            #     if(app.sidebar.button('view landmarks', help='Control landmarks after applying makeup')):
